...
file_o = open('%s_D2A6.txt'%counter,'w')
...
for r in range(NUM_COMMUNICATION_ROUND):
    ...
    model = utils.fedAVG([modelA1.get_weights(),modelA2.get_weights(),modelA3.get_weights(),modelA4.get_weights(),modelA5.get_weights(),modelA6.get_weights()])
